...
@pytest.mark.parametrize('args_kwargs, expected', [
    ...
    (
        [{'args': (1, 2, 3), 'kwargs': {'a': 1, 'b': 1}, }, {'args': (1, ), 'kwargs': {'a': 1, }, }],
        [{'args': (1, 2, 3), 'kwargs': {'a': 1, 'b': 1}}, {'args': (1, ), 'kwargs': {'a': 1, }, }]
    ), # args_kwargs, expected
    (
        [{'args': (1, 2, 3), 'kwargs': {'a': 1, 'b': 1}, }, 11],
        [{'args': (1, 2, 3), 'kwargs': {'a': 1, 'b': 1}}, {'args':(11, ), 'kwargs':{}}]
    ), # args_kwargs, expected
    (
        [{'args': (1, 2, 3), 'kwargs': {'a': 1, 'b': 1}, }, 11, 12],
        [{'args': (1, 2, 3), 'kwargs': {'a': 1, 'b': 1}}, {'args':(11, ), 'kwargs':{}}, {'args':(12, ), 'kwargs':{}}]
    ), # args_kwargs, expected
    ])
